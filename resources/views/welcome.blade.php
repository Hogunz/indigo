<x-guest-layout>
    ...
    <div class="container p-4 mx-auto">
        ...
        <!-- Article -->
        <div class="grid grid-rows-3 grid-flow-col gap-4 text-center w-full content-center ">
            <div class="rounded-md border border-zinc-200 row-span-3 w-96 px-8 py-8 ">
                ...
                <div>
                    <div class="grid grid-row-2 gap-2  bg-violet-50 ">  
                        ...
                        <div class="text-left font-serif text-lg tracking-wide bg-orange-50">Christopher James</div>
                    </div>
                    ...
                    <div class="grid grid-row-2 gap-2 bg-violet-50">
                        ...
                        <div class="text-left font-serif text-lg tracking-wide bg-orange-50">+6399********</div>
                    </div>
                    <div class="grid grid-row-2 gap-2 bg-violet-50">
                        <div class="text-left text-sm  font-base font-serif text-gray-400">
                            Email
                        </div>
                        <div class="text-left font-serif text-lg tracking-wide bg-orange-50">cjdcxxxxxxxxx</div>
                    </div>
                    <div class="grid grid-row-2 gap-2  bg-violet-50">
                        <div class="text-left text-sm  font-base font-serif text-gray-400">
                            Shared on
            ...
            <div class="border-2 border-zinc-200 row-span-3 col-span-2 ">
                <div class="col-span-2 bg-orange-200 p-8 ">
