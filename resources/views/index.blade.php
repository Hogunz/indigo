<x-guest-layout>
  ...
  <main>
    <div class="container-fluid mx-auto">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 ">
          ...
          <div id="carouselExampleControls" class="carousel slide relative" data-bs-ride="carousel">
            <div class="carousel-inner relative w-full overflow-hidden">
              ...
              <div class="carousel-item relative float-left w-full">
                <img src="img/guitarist.png" class="block w-full" alt="Camera" />
              </div>
              <div class="carousel-item relative float-left w-full">
        ...
        <div class="p-4 px-8  flex  place-items-start items-center w-full">
          <div>
            <h1 class="font-bold text-5xl text-left text-blue-500">Whatever you’re planning, <br>make it extraordinary.</h1>
          ...
          <div class="container p-2 mx-auto">
            <main class="min-h pb-8  text-slate-300 flex-none items-center justify-center" x-data="carouselFilter()">
              <div class="grid grid-cols-1">
                ...
                <div class="flex py-8 ">
                  <a class="border rounded-l-lg   inline-block p-4  border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" :class="{ 'text-gray-800': active != 0 }" href="#" @click.prevent="changeActive(0)">EVENT COORDINATOR / PLANNER</a>
                  <a class="border  inline-block p-4  border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" :class="{ 'text-gray-700': active != 1 }" href="#" @click.prevent="changeActive(1)">EVENT STYLISTS</a>
                  <a class="border  inline-block p-4  border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" :class="{ 'text-gray-800': active != 2 }" href="#" @click.prevent="changeActive(2)">CATERER</a>
                  <a class="border  inline-block p-4  border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" :class="{ 'text-gray-700': active != 3 }" href="#" @click.prevent="changeActive(3)">HOTELS / VENUES</a>
                  <a class="border  inline-block p-4  border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" :class="{ 'text-gray-800': active != 4 }" href="#" @click.prevent="changeActive(4)">FASHION DESIGNERS</a>
                  <a class="border  inline-block p-4  border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" :class="{ 'text-gray-700': active != 5 }" href="#" @click.prevent="changeActive(5)">HAIR & MAKEUP</a>
                  <a class="border  inline-block p-4  border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" :class="{ 'text-gray-800': active != 6 }" href="#" @click.prevent="changeActive(6)">CAKES & SWEETS</a>
                  <a class="border  inline-block p-4  border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" :class="{ 'text-gray-700': active != 7 }" href="#" @click.prevent="changeActive(7)">EMCEES / HOSTS</a>
                  <a class="border  inline-block p-4  border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" :class="{ 'text-gray-700': active != 8 }" href="#" @click.prevent="changeActive(8)">INVITATIONS / SOUVENIRS</a>
                  <a class="border  inline-block p-4  border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" :class="{ 'text-gray-700': active != 9 }" href="#" @click.prevent="changeActive(9)">ENTERTAINMENT</a>
                  <a class="border  rounded-r-lg inline-block p-4  border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" :class="{ 'text-gray-700': active != 10 }" href="#" @click.prevent="changeActive(10)">OTHERS</a>
      ...
      <div class=" container p-4 mx-auto font-sans  ">
        ...
        <h1 class="font-bold text-center text-md text-black tracking-widest p-2">Entertainers</h1>
        <div class=" grid grid-cols-4 gap-4 w-2/3 mx-auto">
        ...
        <h1 class="font-bold text-center text-md text-black tracking-widest p-2">Event Services</h1>
        <div class=" grid grid-cols-4 gap-4 w-2/3 mx-auto">
    ...
    <div class=" container mx-auto grid lg:grid-cols-2  ">
      ...
      <div class="p-4 px-8  flex   items-center w-full">
        <div>
    ...
    <div class="pb-6"></div>
    <div class=" container mx-auto grid lg:grid-cols-2 pb-4 ">
      <div class="p-4 px-8  flex place-items-start items-center w-full">
        <div>
          <img class="w-full" src="img/meeting.jpg" alt="">
        </div>
      </div>
      <div class="p-4 px-8  flex   items-center w-full">
        <div>
