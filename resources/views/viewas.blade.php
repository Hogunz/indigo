        ...
        <div id="carouselExampleCaptions" class="carousel slide relative my-2" data-bs-ride="carousel">
            ...
            <div class="carousel-inner relative w-full overflow-hidden">
                <div class="carousel-item active relative float-left w-full">
                    <img src="img/weddinglogo1.jpg" class="block w-full filter grayscale " alt="..." />
                ...
                <div class="carousel-item relative float-left w-full">
                    <img src="img/weddinglogo2.jpg" class="block w-full filter grayscale  " alt="..." />
                    <div class="carousel-caption hidden md:block absolute text-center">
        ...
        <div class="grid grid-rows-3 grid-flow-col gap-4 text-center w-full content-center pb-10">
            <div class="rounded-md border border-zinc-200 row-span-3 w-96 px-8 py-8">
                ...
                <div class=" -space-x-2 overflow-hidden object-center mb-8">
                    <img class="inline-block h-40 w-40 rounded-full ring-2  ring-white filter grayscale " src="img/avatar1.jfif" alt="">
                </div>
                <hr class="px-3 py-3">
                ...
                <div>
                    ...
                    <div class="grid grid-row-2 gap-2 bg-violet-50">
                        ...
                        <div class="text-left font-serif text-lg tracking-wide bg-orange-100">+6399********</div>
                    </div>
                    <div class="grid grid-row-2 gap-2 bg-violet-50">
                        <div class="text-left text-sm  font-base font-serif text-gray-400">
                            Email
                        </div>
                        <div class="text-left font-serif text-lg tracking-wide bg-orange-100">cjdc*************</div>
                    </div>
                    <div class="grid grid-row-2 gap-2  bg-violet-50">
                        <div class="text-left text-sm  font-base font-serif text-gray-400">
                            Shared on
                    ...
                    <div class="grid grid-row-2 gap-2 bg-violet-50 ">
                    <a href=" " class=" h-12 px-4 mt-2 text-center text-base transition-colors duration-300 transform   no-underline hover:underline text-blue-600">
                            View As
                        </a>
                    </div>
                </div>
            ...
            <div class="border-2 border-zinc-200 row-span-3 col-span-2">
                <div class="col-span-2  p-8 " style="background-color:#6f95b6">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div class="border-2 border-zinc-200 filter grayscale">
